...
<div class="thb-content-share">
	...
	<ul>
		...
		<li>
			<a data-type="thb-pinterest" href="//pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php echo $src[0] ?>&description=<?php echo $title; ?>" target="_blank" class="product_share_pinterest">
				<span>
		...
		<li>
			<a data-type="thb-email" href="mailto:enteryour@addresshere.com?subject=<?php echo $title; ?>&body=<?php echo strip_tags(apply_filters( 'woocommerce_short_description', $post->post_excerpt )); ?> <?php the_permalink(); ?>" class="product_share_email">
				<span>
