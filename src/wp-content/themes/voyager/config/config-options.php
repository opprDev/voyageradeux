...
$thb_page = $thb_theme->getAdmin()->getMainPage();
	...
	$thb_container = $thb_tab->getContainer( 'layout_options_header' );
		...
		$thb_field = new THB_GraphicRadioField( 'header_layout' );
			...
			$thb_field->setOptions(array(
				'header-layout-a' => get_template_directory_uri() . '/css/i/options/header-layout-a.png',
				'header-layout-b' => get_template_directory_uri() . '/css/i/options/header-layout-b.png'
			));
