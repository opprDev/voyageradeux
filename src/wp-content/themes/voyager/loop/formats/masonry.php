	...
	<div class="loop-post-content">
			...
			<header class="item-header">
				...
				<?php if( thb_get_post_format() != 'quote' ) : ?>
					...
					<?php if( thb_author_block_enabled( $thb_post_id ) ) : ?>
						<p class="thb-post-author vcard author"><?php _e('by', 'thb_text_domain'); ?> <span class="fn"><?php the_author_posts_link(); ?></span></p>
					<?php endif; ?>
		...
		<?php else : ?>
			<header class="item-header hidden">
				...
				<p class="updated published thb-post-date"><?php echo get_the_date(); ?></p>
